...
def get_keypoints_stats(mypath, myshape, spread, startname = "frame", stophere=2000):
        ...
        while iteration < 10000:
                ...
                print(f_json)
                if not os.path.exists(os.path.join(mypath, f_json)):
                        if os.path.exists(os.path.join(mypath, startname + strmynum + "_keypoints.json")):
                                f_json = startname + strmynum + "_keypoints.json"
                        #else:
                        #        f_json =
                ...
                if os.path.isfile(os.path.join(mypath, f_yaml)) or os.path.isfile(os.path.join(mypath, f_json)):
                        ...
                        print("cannot find file " + os.path.join(mypath, f_json) + " " + str(count))
                        #break
                if count % 5000 == 0:
                        print(count)
                if count >= stophere:
